...
@Client.on_message(filters.command("setapi", [".", "/"]) & filters.user([7679023904]))
...
@Client.on_message(filters.command("viewapis", [".", "/"]) & filters.user([7679023904]))
...
@Client.on_message(filters.command("toggleapi", [".", "/"]) & filters.user([7679023904]))
...
@Client.on_message(filters.command("apiusage", [".", "/"]) & filters.user([7679023904]))
...
@Client.on_message(filters.command("testapi", [".", "/"]) & filters.user([7679023904]))
...
@Client.on_message(filters.command("setschema", [".", "/"]) & filters.user([7679023904]))
